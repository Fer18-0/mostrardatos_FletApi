...
#Actualiza el producto que se le indica con el id y los datos nuevos en ur diccionario 
...
#Borra el producto aue se le indica con el id 
...
# uvicorn app.main:app --reload #Descomenta la siguiente linea antes de ejecutar, 
# te debe mostrar los datos del backend #print(list_products()) 
